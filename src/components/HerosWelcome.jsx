...
export const HerosWelcome = ({title}) => {
    return (
        ...
        <div className='  h-40 sm:h-60 mt-12 sm:mt-16 w-auto overflow-hidden  rounded-b-3xl  border-b border-teal-500'>
            <div className="relative  h-40 sm:h-60">
                  ...
                  <h1 className='absolute inset-0 flex items-center justify-center text-xl lg:text-4xl xl:text-5xl z-20 animate-fade-up animate-duration-[1500ms] animate-ease-in-out'>{title}</h1>
